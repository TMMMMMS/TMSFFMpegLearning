...
@interface TMSMediaAudioContext()
@property (nonatomic, assign)struct TMSAudioInformation audioInformation;
@property(nonatomic, assign)int64_t lastFramePts;

@end
@implementation TMSMediaAudioContext
{
...
- (void)initializeSwr {
    struct TMSAudioInformation audioInformation = [self audioInformation];
